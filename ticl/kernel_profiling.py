...
class TrainKernelProfiler:
    ...
    - exports traces into `output_dir` via tensorboard_trace_handler;
            ...
            top_ops.append(
                {
                    ...
                    "self_cuda_time_us": self._event_metric(e, "self_cuda_time_total"),
                    "cuda_time_us": self._event_metric(e, "cuda_time_total"),
                    "self_cpu_time_us": self._event_metric(e, "self_cpu_time_total"),
