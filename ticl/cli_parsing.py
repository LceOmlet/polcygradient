...
def argparser_from_config(parser, description="Train Mothernet"):
    ...
    optimizer.add_argument('--ppo-pack-prior-milestone', type=str,
                           choices=['sampled_topology', 'gated_reward_path_balance', 'gated_reward_path_balance_terminal_coverage'],
                           help='Explicit prior environment milestone used by the canonical PPO pack runner. sampled_topology keeps the previous milestone; gated_reward_path_balance enables the reward-path-balanced milestone; gated_reward_path_balance_terminal_coverage additionally adds a small terminal-count coverage quota.')
