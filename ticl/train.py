...
def train_epoch_policy_gradient(
    ...
    compile_warmup_enabled = bool(policy_step_compile_active) and (
    ...
    compile_observe_enabled = bool(policy_step_compile_active) and bool(pg_compile_observe_recompiles)
    try:
