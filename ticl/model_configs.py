...
def get_optimizer_config():
    optimizer = {
        ...
        "ppo_value_head_impl": "legacy_bar",
...
def get_prior_config(max_features=100, n_samples=2048):
    ...
    environment_prior_config = {
        ...
        "prior_mlp_activations": {"distribution": "meta_choice", "choice_values": ["sin", torch.nn.Tanh, torch.nn.ReLU]},
